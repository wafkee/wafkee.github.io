...
const config = Object.assign({ type: Phaser.WEBGL, transparent: true, scale: {
        mode: Phaser.Scale.FIT,
        autoCenter: Phaser.Scale.CENTER_BOTH,
        width: 1280,
        height: 768
    }, parent: 'phaser-canvas', fps: {
        target: 60,
        forceSetTimeOut: true
    }, audio: {
        disableWebAudio: false
    }, scene: [preLoadingScene_1.default, preloadScene_1.default, mainScene_1.default], backgroundColor: '#000000' }, phaser_extension_1.Canvas());
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Blade; });
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @enable3d/phaser-extension */ "./node_modules/@enable3d/phaser-extension/dist/index.js");
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__);
...
class Blade{
	  ...
	  checkFruitsUI(fruitFactory){
		...
		if(clickedHomeClassic || clickedHomeSetting || clickedSettingBack || clickedResultQuit || clickedResultRetry){
			points = [{"x":363.08797127468586, "y":356.1988919279052}, {"x":363.08797127468586, "y":355.04986324426676}]
		}
	  	...
	  	for (var i = 1; i < points.length; i++) {
	          ...
	          listFruits.forEach(fruitObj => {
	          		...
	          		if(fruitObj.active && res==''){
						...
						let modifiedLine = {"type": 2, "x1": posFruit.x, "x2": posFruit.x, "y1": posFruit.y, "y2": posFruit.y,
						"bottom": posFruit.y, "left": posFruit.x, "right": posFruit.x, "top": posFruit.y};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ComboText; });
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @enable3d/phaser-extension */ "./node_modules/@enable3d/phaser-extension/dist/index.js");
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__);
...
class ComboText extends Phaser.GameObjects.Container {
    constructor(scene, x, y) {
        ...
        this.scene = scene;
        this.textAtas = this.scene.add.text(0, 0, "N Fruit", { fontFamily: "gangofchinese", fontSize: 60, align: 'center' });
        ...
        this.textTengah = this.scene.add.text(0, this.textAtas.height/2 + 30, "Combo", { fontFamily: "gangofchinese", fontSize: 60, align: 'center' });
        ...
        this.textBawah = this.scene.add.text(0, this.textTengah.y + this.textAtas.height/2 + 50, "+ N", { fontFamily: "gangofchinese", fontSize: 140, align: 'center' });
        ...
        this.textAtas2 = this.scene.add.text(0, 0, "N Fruit", { fontFamily: "gangofchinese", fontSize: 60, align: 'center' });
        ...
        this.textAtas3 = this.scene.add.text(0, 0, "N Fruit", { fontFamily: "gangofchinese", fontSize: 60, align: 'center' });
        ...
        this.textTengah2 = this.scene.add.text(0, this.textAtas.height/2 + 30, "Combo", { fontFamily: "gangofchinese", fontSize: 60, align: 'center' });
        ...
        this.textTengah3 = this.scene.add.text(0, this.textAtas.height/2 + 30, "Combo", { fontFamily: "gangofchinese", fontSize: 60, align: 'center' });
        ...
        this.textBawah2 = this.scene.add.text(0, this.textTengah.y + this.textAtas.height/2 + 50, "+ N", { fontFamily: "gangofchinese", fontSize: 140, align: 'center' });
        ...
        this.textBawah3 = this.scene.add.text(0, this.textTengah.y + this.textAtas.height/2 + 50, "+ N", { fontFamily: "gangofchinese", fontSize: 140, align: 'center' });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CriticalText; });
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @enable3d/phaser-extension */ "./node_modules/@enable3d/phaser-extension/dist/index.js");
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__);
...
class CriticalText extends Phaser.GameObjects.Container {
    constructor(scene, x, y) {
        ...
        this.textAtas = this.scene.add.text(0, 0, "CRITICAL", { fontFamily: "gangofchinese", fontSize: 60, align: 'center' });
        this.textAtas.setOrigin(0.5,0.5);
        ...
        this.textBawah = this.scene.add.text(0, 0, "+10", { fontFamily: "gangofchinese", fontSize: 120, align: 'center' });
        this.textBawah.setOrigin(0.5,0.5);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FruitFactory; });
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @enable3d/phaser-extension */ "./node_modules/@enable3d/phaser-extension/dist/index.js");
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__);
...
class FruitFactory{
	...
	constructor(scene) {
		...
		global.gameData = {
			...
			fruitList:[
				{id: "Coconut",path: "assets/fruits/Coconut.FBX",scale: 1.2413, splashColor: 0xF9FFFF, alpha: 179, splashTex: 'splash', droplets: 'JuiceDragonFruit', impactSFX:'FruitImpactBigHollow', minSplash:2 , maxSplash:4 },
				{id: "Pineapple",path: "assets/fruits/Pineapple.FBX",scale: 1.1526, splashColor: 0xFFEF3F, alpha: 180, splashTex: 'splash', droplets: 'JuicePineapple', impactSFX:'FruitImpactBigWet0', minSplash:2 , maxSplash:3},
				{id: "Orange",path: "assets/fruits/Orange.FBX",scale: 1.034, splashColor: 0xFC7804, alpha: 180, splashTex: 'splash', droplets: 'JuiceOrange', impactSFX:'FruitImpactBigWet0', minSplash:3 , maxSplash:4},
				{id: "Kiwifruit",path: "assets/fruits/Kiwifruit.FBX",scale: 0.8866, splashColor: 0x54AD10, alpha: 180, splashTex: 'splash', droplets: 'JuiceGreen', impactSFX:'FruitImpactSmallWet0', minSplash:1 , maxSplash:4},
				{id: "Lemon",path: "assets/fruits/Lemon.FBX",scale: 0.9753, splashColor: 0xFFEF3F, alpha: 180, splashTex: 'splash', droplets: 'JuicePineapple', impactSFX:'FruitImpactMediumWet0', minSplash:3 , maxSplash:4},
				{id: "Peach",path: "assets/fruits/Peach.FBX",scale: 1.0108, splashColor: 0xFFC51B, alpha: 180, splashTex: 'splash', droplets: 'JuiceMango', impactSFX:'FruitImpactMediumWet0', minSplash:4 , maxSplash:4},
				{id: "AppleGreen",path: "assets/fruits/AppleGreen.FBX",scale: 1.064, splashColor: 0xFEDC35, alpha: 179, splashTex: 'splash2', droplets: 'JuicePineapple', impactSFX:'FruitImpactApple', minSplash:2 , maxSplash:2},
				{id: "Mango",path: "assets/fruits/Mango.FBX",scale: 1.1526, splashColor: 0xFFB720, alpha: 180, splashTex: 'splash', droplets: 'JuiceMango', impactSFX:'FruitImpactMediumWet0', minSplash:2 , maxSplash:4},
				{id: "Watermelon",path: "assets/fruits/Watermelon.FBX",scale: 1.33, splashColor: 0xFB2618, alpha: 255, splashTex: 'splash', droplets: 'JuiceRed', impactSFX:'FruitImpactBigWet0', minSplash:3 , maxSplash:4},
        {id: "WMUI",path: "assets/fruits/Watermelon.FBX",scale: 1.33, splashColor: 0xFB2618, alpha: 255, splashTex: 'splash', droplets: 'JuiceRed', impactSFX:'FruitImpactBigWet0', minSplash:3 , maxSplash:4},
        {id: "KWUI",path: "assets/fruits/Kiwifruit.FBX",scale: 0.8866, splashColor: 0x54AD10, alpha: 180, splashTex: 'splash', droplets: 'JuiceGreen', impactSFX:'FruitImpactSmallWet0', minSplash:1 , maxSplash:4},
        {id: "BUI",path: "assets/fruits/Bomb.fbx",scale: 1.0, splashTex: 'none', droplets: 'none', impactSFX:'BombExplodeGameOver'},
        {id: "AGUI",path: "assets/fruits/AppleGreen.FBX",scale: 1.064, splashColor: 0xFEDC35, alpha: 179, splashTex: 'splash2', droplets: 'JuicePineapple', impactSFX:'FruitImpactApple', minSplash:2 , maxSplash:2},
				{id: "Banana",path: "assets/fruits/Banana.FBX",scale: 0.95, splashTex: 'none', droplets: 'none', impactSFX:'FruitImpactMediumDry'},
        {id: "Bomb",path: "assets/fruits/Bomb.fbx",scale: 1.0, splashTex: 'none', droplets: 'none', impactSFX:'BombExplodeGameOver'}
			],
    ...
    populateRayForBomb(bomb){
      ...
      for(let i=0;i<nRay;i++){
        this.scene.third.load.fbx('assets/effects/PomegranateRay.fbx').then(object => {
          ...
          const material = new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"].MeshPhongMaterial({ map: this.bombRayTexture })
    ...
    createEmitter(textureName, startScale = 2.0){
      ...
      if(id=='WMUI'){
    	...
    	this.scene.third.load.fbx(path).then(object => {
            ...
            if ( child.isMesh ) {
              if(child.name.includes("Outline") || child.name.includes("outline")){
                if(id!="Bomb" && id!="BUI"){
                  ...
                  const outlineColor = new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"].MeshLambertMaterial({ color: 0xff0000 });
          ...
          const material = new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"].MeshPhongMaterial({ map: this.shadowTexture })
          material.transparent = true;
          ...
          if(data.splashTex!='none'){
            ...
            for(let a=0;a<4;a++){
              const materialSplash = new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"].MeshPhongMaterial({ map: texture, color: data.splashColor})
          ...
          const item = {object,active: true,pastScreen: false,willActive: false,count: 0,sliced: false,half1BasePos,half2BasePos,shadow,id,splash: splash,hasSplash: hasSplash,droplets: data.droplets, impactSFX: data.impactSFX,splashColor:data.splashColor,minSplash:data.minSplash,maxSplash:data.maxSplash,fruitTrail,theBombTrail,criticalTrailHalf1,criticalTrailHalf2};
          console.log(object);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SliceCriticalEffect; });
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @enable3d/phaser-extension */ "./node_modules/@enable3d/phaser-extension/dist/index.js");
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SliceEffect; });
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @enable3d/phaser-extension */ "./node_modules/@enable3d/phaser-extension/dist/index.js");
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__);
...
class MainScene extends _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["Scene3D"] {
  ...
  async create() {
   ...
   //CREATE BACKGROUND DOJO
    ...
    const material = new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"].MeshLambertMaterial({ map: textureDojo })
  ...
  async resumeLoad(){
    ...
    const materialRing = new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"].MeshPhongMaterial({ map: textureRing })
    ...
    const materialShadowRing = new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"].MeshPhongMaterial({ map: textureShadowRing })
    ...
    const materialRingSettings = new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"].MeshPhongMaterial({ map: textureRingSettings })
    ...
    let textSlice = this.add.text(0, -2, "Tap Fruit\nto begin", { fontFamily: "gangofchinese", fontSize: 30, color: '#5E3C0D', align: 'center' });
    ...
    this.textReady = this.add.text(420, 560, "Ready", { fontFamily: "gangofchinese", fontSize: 150 });
    ...
    this.textGo = this.add.text(490, 560, "GO!!", { fontFamily: "gangofchinese", fontSize: 150 });
    ...
    this.textBest = this.add.text(25, 110, "Best: 0", { fontFamily: "gangofchinese", fontSize: 35 });
    ...
    this.textBestGreen = this.add.text(25, 110, "Best: 0", { fontFamily: "gangofchinese", fontSize: 35 });
    ...
    const materialRingPA = new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"].MeshPhongMaterial({ map: textureRingPA })
    ...
    const materialRingQuit = new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"].MeshPhongMaterial({ map: textureRingQuit })
    ...
    //LEVEL DESIGN
    this.waveList = [
      {id:1,minWave:0,chance:90,chanceRegrowth:0.33,delay:1,dtScale:0.9,dtScaleIncrease:0,fruitChance:[{fruits:['Watermelon'],min:1,max:1,between:0}]},
      {id:2,minWave:1,chance:90,chanceRegrowth:0.33,delay:1,dtScale:0.9,dtScaleIncrease:0,fruitChance:[{fruits:['R'],min:1,max:1,between:0}]},
      {id:3,minWave:2,chance:90,chanceRegrowth:0.33,delay:1,dtScale:0.9,dtScaleIncrease:0,fruitChance:[{fruits:['R'],min:2,max:3,between:0}]},
      {id:4,minWave:4,chance:90,chanceRegrowth:0.33,delay:0.8,dtScale:0.9,dtScaleIncrease:0,fruitChance:[{fruits:['Bomb'],min:1,max:2,between:0}]},
      {id:5,minWave:5,chance:90,chanceRegrowth:0.33,delay:0.8,dtScale:0.9,dtScaleIncrease:0,fruitChance:[{fruits:['Bomb'],min:1,max:1,between:0},{fruits:['R'],min:1,max:2,between:0}]},
      {id:6,minWave:5,chance:90,chanceRegrowth:0.33,delay:0.8,dtScale:0.9,dtScaleIncrease:0,fruitChance:[{fruits:['R'],min:7,max:7,between:0.7}]},
      {id:7,minWave:9,chance:90,chanceRegrowth:0.33,delay:0.8,dtScale:0.95,dtScaleIncrease:0,fruitChance:[{fruits:['R','R','B'],min:4,max:6,between:0.6}]},
      {id:8,minWave:9,chance:90,chanceRegrowth:0.33,delay:0.8,dtScale:0.95,dtScaleIncrease:0,fruitChance:[{fruits:['R'],min:4,max:6,between:0}]},
      {id:9,minWave:9,chance:90,chanceRegrowth:0.33,delay:0.8,dtScale:0.95,dtScaleIncrease:0,fruitChance:[{fruits:['R','R','R','B'],min:3,max:4,between:0}]},
      {id:10,minWave:14,chance:90,chanceRegrowth:0.33,delay:0.8,dtScale:0.95,dtScaleIncrease:0,fruitChance:[{fruits:['Bomb'],min:1,max:2,between:0},{fruits:['R'],min:2,max:3,between:0}]},
      {id:11,minWave:14,chance:90,chanceRegrowth:0.33,delay:0.8,dtScale:1.0,dtScaleIncrease:0,fruitChance:[{fruits:['R','R','B'],min:16,max:16,between:0.4}]},
      {id:12,minWave:14,chance:90,chanceRegrowth:0.33,delay:0.8,dtScale:1.0,dtScaleIncrease:0,fruitChance:[{fruits:['R'],min:10,max:10,between:0.3}]},
      {id:13,minWave:19,chance:90,chanceRegrowth:0.33,delay:0.8,dtScale:1.0,dtScaleIncrease:0,fruitChance:[{fruits:['R','R','B'],min:8,max:8,between:0.5,delayInc:-0.2}]},
      {id:14,minWave:19,chance:90,chanceRegrowth:0.33,delay:0.8,dtScale:1.0,dtScaleIncrease:0,fruitChance:[{fruits:['R','R','R','R','R','B'],min:4,max:6,between:0}]},
      {id:15,minWave:22,chance:67,chanceRegrowth:0.33,delay:0.8,dtScale:1.0,dtScaleIncrease:0.02,fruitChance:[{fruits:['R','R','R','B'],min:5,max:10,between:0.4}]},
      {id:16,minWave:22,chance:67,chanceRegrowth:0.33,delay:0.8,dtScale:1.0,dtScaleIncrease:0.02,fruitChance:[{fruits:['R','R','R','B'],min:3,max:5,between:0.4}]},
      {id:17,minWave:22,chance:67,chanceRegrowth:0.33,delay:0.8,dtScale:0.9,dtScaleIncrease:0.02,fruitChance:[{fruits:['R'],min:4,max:7,between:0.25}]},
      {id:18,minWave:22,chance:68,chanceRegrowth:0.33,delay:0.8,dtScale:1.0,dtScaleIncrease:0.02,fruitChance:[{fruits:['R','R','B'],min:5,max:7,between:0.4}]}
    ];
    this.waveCounter = 0;
    ...
    let textAudio = this.add.text(1100, 160, 'Audio', {fontFamily:'gangofchinese', fontSize:60, color:'#653A11',align:'center'}).setOrigin(0.5, 0);
    ...
    this.textVersi = this.add.text(450, 708, 'v1.1.0.8', {fontFamily:'gangofchinese', fontSize:30, color:'#FFFFFF',align:'center'}).setOrigin(0.5, 0);
    ...
    const materialRingBack = new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"].MeshPhongMaterial({ map: textureRingBack })
  ...
  createCreditsText(){
    ...
    let textAbout = this.add.text(490, 140, 'About', {fontFamily:'gangofchinese', fontSize:80, color:'#B74A32',align:'center'}).setOrigin(0.5, 0.5);
    wholeCredit.add(textAbout);
    let textGameDesc = this.add.text(490, 180, 'All ninjas hate fruit!\nSwipe the fruit with your finger to end their journey\n\nBe wary of bombs, and make sensei proud', {fontFamily:'gangofchinese', fontSize:33, color:'#6F461E',align:'center'}).setOrigin(0.5, 0);
    ...
    let textHTML5Port = this.add.text(490, 370, 'EXCLUSIVE PARTNER:', {fontFamily:'gangofchinese', fontSize:33, color:'#4D2E11',align:'center'}).setOrigin(0.5, 0);
    let textIsiPort = this.add.text(490, 410, 'STORMS', {fontFamily:'gangofchinese', fontSize:28, color:'#693E17',align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(textCredit);
    wholeCredit.add(textHTML5Port);
    wholeCredit.add(textIsiPort);

    let textCurrentTeam = this.add.text(490, 630, 'Current Team', {fontFamily:'gangofchinese', fontSize:45, color:'#689927',align:'center'}).setOrigin(0.5, 0);
    ...
    let t_teamLead = this.add.text(left, startY, 'Team Lead', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_teamLead = this.add.text(left, startY + t_teamLead.height + 5, 'Shainiel Deo', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_teamLead);
    wholeCredit.add(n_teamLead);

    let t_art = this.add.text(right, startY, 'Art', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_art = this.add.text(right, startY + t_art.height + 5, 'Laura McCabe', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_art);
    wholeCredit.add(n_art);

    startY = n_teamLead.y + n_teamLead.height + distanceY;

    let t_code = this.add.text(left, startY, 'Code', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_code = this.add.text(left, startY + t_code.height + 5, 'Samantha Turner\nVictor Rykov\nKayleb Garrett', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);        
    wholeCredit.add(t_code);
    wholeCredit.add(n_code);

    let t_design = this.add.text(right, startY, 'Design', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_design = this.add.text(right, startY + t_design.height + 5, 'Shainiel Deo\nDylan Van Beek', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    ...
    let t_qa = this.add.text(left, startY, 'QA', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_qa = this.add.text(left, startY + t_qa.height + 5, 'Brent Hobson', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_qa);
    wholeCredit.add(n_qa);

    let t_cs = this.add.text(right, startY, 'Customer Support', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_cs = this.add.text(right, startY + t_cs.height + 5, 'Madison Annibale\nAkaash Deo\nSam Scarpignato', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_cs);
    wholeCredit.add(n_cs);

    startY = Math.max(n_qa.y + n_qa.height, n_cs.y + n_cs.height) + distanceY;

    let t_audio = this.add.text(left, startY, 'Audio', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_audio = this.add.text(left, startY + t_audio.height + 5, 'Cedar Jones\nJamie Campbell\nRicardo Pujol', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_audio);
    wholeCredit.add(n_audio);

    let t_marketing = this.add.text(right, startY, 'Marketing', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_marketing = this.add.text(right, startY + t_marketing.height + 5, 'Jason Maundrell\nSalvatore Compagnone\nOlivia Bambury\nParis Ormerod', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);        
    ...
    let t_originalTeam = this.add.text(mid, startY, 'Original Team', {fontFamily:'gangofchinese', fontSize:45, color: "#689927", align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_originalTeam);

    startY = t_originalTeam.y + t_originalTeam.height + distanceY;

    let t_teamLead2 = this.add.text(left, startY, 'Team Lead / Design', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_teamLead2 = this.add.text(left, startY + t_teamLead2.height + 5, 'Luke Muscat', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_teamLead2);
    wholeCredit.add(n_teamLead2);

    let t_art2 = this.add.text(right, startY, 'Art', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_art2 = this.add.text(right, startY + t_art2.height + 5, 'Shath', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    ...
    let t_code2 = this.add.text(left, startY, 'Code', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_code2 = this.add.text(left, startY + t_code2.height + 5, 'Adam Wood\nStephen Last', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_code2);
    wholeCredit.add(n_code2);

    let t_qa2 = this.add.text(right, startY, 'QA', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_qa2 = this.add.text(right, startY + t_qa2.height + 5, 'Brent Hobson\nJason Maundrell', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_qa2);
    wholeCredit.add(n_qa2);

    startY = Math.max(n_code2.y + n_code2.height, n_qa2.y + n_qa2.height) + distanceY;

    let t_audio2 = this.add.text(left, startY, 'Audio', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_audio2 = this.add.text(left, startY + t_audio2.height + 5, 'Jesse Higginson\nCedar Jones', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_audio2);
    wholeCredit.add(n_audio2);

    let t_production = this.add.text(right, startY, 'Production', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_production = this.add.text(right, startY + t_production.height + 5, 'Jason Harwood', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    ...
    let t_marketing2 = this.add.text(mid, startY, 'Marketing', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_marketing2 = this.add.text(mid, startY + t_marketing2.height + 5, 'Beverley Chen', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_marketing2);
    wholeCredit.add(n_marketing2);

    startY = n_marketing2.y + n_marketing2.height + distanceY;

    let t_add_development = this.add.text(mid, startY, 'Additional Development', {fontFamily:'gangofchinese', fontSize:45, color: "#689927", align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_add_development);

    startY = t_add_development.y + t_add_development.height + distanceY;

    let n_leftTeam = this.add.text(left, startY, 'Adam Nichols\nAnthony Hansen\nAlex Butterfield\nAlex Richardson\nAshley Muller\nBen Marrinan\nBen Vale\nBertrand Thomachot\nBrendon Thomas\nCorey Hearder\nCorey Taylor\nDaemon Walters\nDale Williams\nDaniel Baxter\nDaniel Fisher\nDaniel John\nDean Loades\nElliot Courtney\nEmma Koch\nGareth Heavon-Jones\nGemma Refalo\nGuillaume Evrard\nMark Hurst\nHugh Walters\nJames Barnes\nJames Quick\nJared Oats\nJason Robson\nJesse Higginson', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    let n_rightTeam = this.add.text(right, startY, 'John Qian\nJohnathon Carr\nJonathan Law\nJordan Comino\nJosh Sanderson\nKate Hynes\nLayton Hawkes\nMatt Millwood\nMatt Ross\nMatthew Knights\nMelanie Devoy\nMichael Dobele\nMichael Szewczyk\nMotze Asher\nMurry Lancashire\nNathan Steenstra\nPaul McNab\nPhil Larsen\nRamine Darabiha\nResa Liputra\nRichard McKinney\nRod Wong\nRyan Langley\nSean Druitt\nSean Ockert\nTerry Greisbach\nWill Goddard\nWren Brier\nZac Congo', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    ...
    let t_ceo = this.add.text(left, startY, 'CEO', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_ceo = this.add.text(left, startY + t_ceo.height + 5, 'Shainiel Deo', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_ceo);
    wholeCredit.add(n_ceo);

    let t_cfo = this.add.text(right, startY, 'CFO', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_cfo = this.add.text(right, startY + t_cfo.height + 5, 'Rinal Deo', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_cfo);
    wholeCredit.add(n_cfo);

    startY = Math.max(n_ceo.y + n_ceo.height, n_cfo.y + n_cfo.height) + distanceY;

    let t_marketing3 = this.add.text(left, startY, 'Marketing', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_marketing3 = this.add.text(left, startY + t_marketing3.height + 5, 'Beverley Chen\nBob Jones\nFiona Guo\nJames Schultz\nJustin Bowen\nMichelle Whitehead\nPhoebe Ong\nScheree Reeves\nTerry Greisbach\nToby Meadows', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_marketing3);
    wholeCredit.add(n_marketing3);

    let t_engine = this.add.text(right, startY, 'Engine', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    ...
    let t_qa3 = this.add.text(left, startY, 'QA', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_qa3 = this.add.text(left, startY + t_marketing3.height + 5, 'Charles Bussy\nClement Valette\nKirby Scarfe\nSethlans Vayu', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_qa3);
    wholeCredit.add(n_qa3);

    let t_support = this.add.text(right, startY, 'Support', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    ...
    let t_special = this.add.text(mid, startY, 'Special Thanks', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_special = this.add.text(mid, startY + t_engine.height + 5, 'Char + Emma Wood\nKaaren + Raymond Hawkes\nKate Exley\nKing Dragon Le + Family\nLauren Fryer\nLeah Mostyn\nMadonna + Callum Bryan\nNatalie Clarke\nNell + Calyb Rehua\nShinta Liputra\nStella Kalis', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_special);
    wholeCredit.add(n_special);

    startY = n_special.y + n_special.height + distanceY;

    let t_copyright = this.add.text(mid, startY, '© 2010 - 2021 Halfbrick Studios Pty Ltd. FRUIT NINJA®\nGame characters, Halfbrick and logo are trademarks of\nHalfbrick Studios Pty Ltd and are protected by copyright.\nAll rights reserved.', {fontFamily:'gangofchinese', fontSize:28, color: cMember, align:'center'}).setOrigin(0.5, 0);
    wholeCredit.add(t_copyright);
    
    startY = t_copyright.y + t_copyright.height + distanceY;

    let t_fact = this.add.text(mid, startY, 'Bonus Fruit Fact', {fontFamily:'gangofchinese', fontSize:fontSize, color: cDivision, align:'center'}).setOrigin(0.5, 0);
    let n_fact = this.add.text(mid, startY + t_fact.height + 5, 'Sensei loves prunes! :p', {fontFamily:'gangofchinese', fontSize:fontSize, color: cMember, align:'center'}).setOrigin(0.5, 0);
    ...
    // let textCredit = this.add.text(490, 480, 'Credits', {fontFamily:'gangofchinese', fontSize:80, color:'#B74A32',align:'center'}).setOrigin(0.5, 0);
    let sthanksog = this.add.text(490, startY, 'Special Thanks:', {fontFamily:'gangofchinese', fontSize:33, color:'#4D2E11',align:'center'}).setOrigin(0.5, 0);
    let thanksogid = this.add.text(490, startY+sthanksog.height+5, 'Own Games Indonesia', {fontFamily:'gangofchinese', fontSize:28, color:'#693E17',align:'center'}).setOrigin(0.5, 0);
  ...
  initResultScreen(){
    ...
    let titleText = this.add.text(640, 70, "SCORE", { fontFamily: "gangofchinese", fontSize: 85 });
    ...
    this.textScoreGameover = this.add.text(640, 265, "0", { fontFamily: "gangofchinese", fontSize: 275 });
    ...
    this.newBestText = this.add.text(640, 380, "NEW BEST!", { fontFamily: "gangofchinese", fontSize: 55 });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PreloadingScene; });
...
function initializePokiSDK(){
  ...
  PokiSDK.init().then(() => {
    ...
    pokiGameLoadingFinished();
    setTimeout(function() { pokiRewardBread(); }, 2500);
  }).catch(() => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return BombTrail; });
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @enable3d/phaser-extension */ "./node_modules/@enable3d/phaser-extension/dist/index.js");
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CriticalTrail; });
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @enable3d/phaser-extension */ "./node_modules/@enable3d/phaser-extension/dist/index.js");
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FruitTrail; });
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @enable3d/phaser-extension */ "./node_modules/@enable3d/phaser-extension/dist/index.js");
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LinearSpline; });
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @enable3d/phaser-extension */ "./node_modules/@enable3d/phaser-extension/dist/index.js");
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ScreenShake; });
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @enable3d/phaser-extension */ "./node_modules/@enable3d/phaser-extension/dist/index.js");
/* harmony import */ var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__);
